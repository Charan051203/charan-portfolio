      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Contact Form */}
            <motion.div 
              className="glassmorphism rounded-2xl p-6 md:p-8 border border-primary/20 shadow-lg relative overflow-hidden"
            ...
            >
              ...
              <motion.h4 
                className="text-xl md:text-2xl font-bold mb-6 text-gradient relative z-10 text-left"
            ...
            <div className="relative flex items-center justify-center h-full min-h-[250px] lg:min-h-[300px]">
              ...
              <motion.div 
                className="relative z-10 w-full max-w-[280px] md:max-w-[320px] rounded-2xl overflow-hidden border-2 border-primary/20"
                animate={{
                  y: [0, -15, 0],
                  rotate: [0, 1, 0]
                }}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                <motion.div 
                  className="flex flex-col md:flex-row items-center md:items-start md:space-x-4 text-center md:text-left"
